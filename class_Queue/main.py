class Queue:
    ...
    def __repr__(self):
        return f'Queue({[i for i in self.pairs.items()]})'

    def __len__(self):
        return len(self.pairs)

    def add(self, elem):
        if elem[0] in self.pairs.keys():
    ...
    def pop(self):
        ...
        p = list(self.pairs.keys())[0]
        res = list(self.pairs.items())[0]
        del self.pairs[p]
        return res
...
if __name__ == '__main__':
    ...
    data = [('Kerry Martinez', 36), ('Todd Watson', 47), ('Andrew Elliott', 56), ('Jamie Collins', 44),
            ...
            ('Duane Dixon', 57), ('Sierra Graves', 30), ('Todd Watson', 46), ('Amanda Wilson', 45),
            ('Nicole Johnson', 24),
            ...
            ('Tim Williams', 29), ('Angela Johnson', 41), ('Duane Watson', 31), ('Tamara Wood', 13),
            ('Julie Morris', 40),
            ...
            ('Valerie Hunt', 18), ('Jasmin May', 31), ('Ethan Smith', 57), ('Cynthia Miles', 32),
            ('Thomas Johnson', 19),
            ('Brenda Ochoa', 39), ('Tammy Shields', 16), ('Jodi Combs', 17), ('Edward Evans', 50),
            ('Susan Maldonado', 49),
            ...
            ('James Stein', 24), ('Joshua Moore', 44), ('Aaron Chandler', 48), ('Jason Vance', 18),
            ('David Williams', 48),
            ('Donna Johnson', 45), ('Shelby Schmidt', 25), ('Cody Ford', 35), ('William Hampton', 41),
            ('Michael Cooper', 20), ('Megan Snyder', 34), ('Wendy Baxter', 47), ('Nicole Walker', 16),
            ('Kelly Harris', 57),
            ...
            ('Candace Aguirre', 49), ('Curtis Hall', 20), ('Adam Bush', 46), ('Carrie Williams', 26),
            ('Lisa Barker', 27),
